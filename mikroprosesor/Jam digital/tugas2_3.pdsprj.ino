...
unsigned char _minute = 30;
unsigned char _hour = 18;
    ...
    case 3:
      if(Update3 == ON)
      {
        if(Alarmbutton1 == 0)
        {
          ...
          tm1637.display(0x00, AlarmDisp[0]);
          tm1637.display(0x01, AlarmDisp[1]);
          if(ClockPoint)tm1637.display(0x02, AlarmDisp[2]);
          else tm1637.display(0x02, 0x7f);
          if(ClockPoint)tm1637.display(0x03, AlarmDisp[3]);
          else tm1637.display(0x03, 0x7f);
        }
        else if(Alarmbutton1 == 1)
        {
          ...
          if(ClockPoint)tm1637.display(0x00, AlarmDisp[0]);
          else tm1637.display(0x00, 0x7f);
          if(ClockPoint)tm1637.display(0x01, AlarmDisp[1]);
          else tm1637.display(0x01, 0x7f);
          tm1637.display(0x02, AlarmDisp[2]);
          tm1637.display(0x03, AlarmDisp[3]);
        }
        AlarmUpdate();
      }
      break;
